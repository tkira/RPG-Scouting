        ...
        while (spawned == false) {
            ...
            if (changeChecker == openingDirection + closedValues) { //If it doesnt still match it will reloop
                ...
                if (rand3 == 0) {
                    ...
                    GameObject mapC = Instantiate (monstersTemplates.mapChest, new Vector3 (x, y, 0), Quaternion.identity);
                    mapC.transform.SetParent (GameObject.FindGameObjectWithTag ("MapGUI").transform, false);
